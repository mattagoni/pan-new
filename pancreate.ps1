...
New-AzResourceGroupDeployment -ResourceGroupName "magoni" -TemplateFile "/home/matthew/pan-new/pandeploytemplate.json" -TemplateParameterFile "/home/matthew/pan-new/pandeploymentparameters.json"
